...
public class FujiXerox_MFP1 extends Scanner {
	...
	private UsbPipe interrupt = null;
	private UsbPipe input = null;
	private UsbPipe output = null;
	...
	protected Object[] setup() throws Exception {
		...
		interrupt = interrpu_ep.getUsbPipe();
		input = input_ep.getUsbPipe();
		output = output_ep.getUsbPipe();
		interrupt.open();
		output.open();
		input.open();
